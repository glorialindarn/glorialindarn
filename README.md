...
> *"Uncovering patterns in data and transforming insights into meaningful stories."*

Final-year **Bachelor of Science (Honours) Statistics specializing in Big Data Analytics** student actively seeking an **Internship** placement. Passionate about econometrics, exploratory data analysis, natural language processing, predictive modeling, and data storytelling.

---

### 🔍 Focus Areas
- **Statistical Modeling & Forecasting:** Time series econometrics, cointegration analysis (ARDL-ECM), dynamic forecasting, and regression modeling.
- **Data Storytelling & Visual Reporting:** Designing interactive dashboards and translating complex data into decision-ready narratives.
- **Text Analytics & NLP:** Mining unstructured text, web scraping, sentiment analysis, and predictive classification.
- **Intelligent Decision Systems:** Constructing data-driven decision architectures and Big Data pipelines.

---

### 📚 Currently Exploring & Learning
- **Business Data Analytics & NLP:** Unstructured data manipulation (MongoDB), web scraping (`BeautifulSoup` / Web Scraper), sentiment analysis, and text mining (TF-IDF).
- **Data Representation & Narrative Design:** Dashboard UX/UI architecture, visual encoding (Power BI / Excel), and reproducible reporting.
- **Intelligent Decision Support Systems (DSS):** Data warehousing, ETL pipelines, OLAP, expert systems, and Big Data technologies (Hadoop / MapReduce).
...
- **R Ecosystem:** `ARDL` • `forecast` • `tidyverse` • `dplyr` • `ggplot2` • `shiny`
- **Python Ecosystem:** `pandas` • `numpy` • `scikit-learn` • `matplotlib` • `seaborn` • `BeautifulSoup`
- **BI & Visual Reporting:** Power BI • Tableau • Advanced Excel (Pivot / Charts)
- **Analytics Platforms & Tools:** RStudio • RapidMiner (AI Studio) • Jupyter • SPSS • SAS • Git
...
### 📬 Get in Touch
- 📧 **Email:** [glorialinda.rn@gmail.com](mailto:glorialinda.rn@gmail.com)
- 💬 **WhatsApp / Call:** [+60 11-3910 1387](https://wa.me/601139101387)
